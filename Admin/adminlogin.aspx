            ...
            <div class="card card-primary">
              ...
              <form role="form" id="loginform" runat="server">
                ...
                <div class="card-footer form-group">
                    ...
                    <asp:Button ID="login_btn" runat="server" Text="LOGIN" class="btn btn-primary" OnClick="login_btn_Click"/>
                    <asp:Label ID="Label2" runat="server" Text="Don't have an Account? " style="padding-left:35%;"></asp:Label><a href="adminregister.aspx">Register here!</a>
